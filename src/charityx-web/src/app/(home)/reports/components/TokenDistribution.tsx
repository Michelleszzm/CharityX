...
import { ReportDistributionToken } from "@/apis/fundraise"
...
const CustomTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    const data = payload[0].payload as ReportDistributionToken
...
interface Props {
  value: ReportDistributionToken[]
}

export default function TokenDistribution({ value }: Props) {
  return (
