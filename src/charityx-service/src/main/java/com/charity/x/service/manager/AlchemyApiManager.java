...
public class AlchemyApiManager {
    ...
    private static final String ALCHEMY_SOLANA_API_ENDPOINT = "https://solana-mainnet.g.alchemy.com/v2/oc1ejxYpVN9_VWgZ7GYH-rm2bpxnylp1";
//    private static final String ALCHEMY_SOLANA_API_ENDPOINT = "https://mainnet.helius-rpc.com/?api-key=39e3f738-b2a4-4dd7-b9a6-f29762ca010a";
    @Lazy
    @Autowired
